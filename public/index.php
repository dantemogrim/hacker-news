            ...
            <div class="d-flex flex-row bd-highlight mb-3">
                <div class="d-flex align-items-center">
                    <div class="votes">
                        ...
                        <a class="" target="_blank" href="/public/front/comments/gui-cmnt-section.php?post_id=<?= $articlePost['id'] ?>">Comment Section</a>
                    </div>
                </div>
            </div>

            <?php if ($ownedBy) : ?>
                <!-- Edit post option - if user is the publisher. -->
                <div class="d-flex flex-row bd-highlight mb-3">
                    ...
                    <!-- Delete post option - if user is the publisher. -->
